...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets Run_IBUF]
...
set_property -dict {PACKAGE_PIN L1 IOSTANDARD LVCMOS33} [get_ports {SS[1]}]
set_property -dict {PACKAGE_PIN K2 IOSTANDARD LVCMOS33} [get_ports {SS[0]}]
set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports {PGen}]
...
##set_property -dict {PACKAGE_PIN A4 IOSTANDARD LVCMOS33} [get_ports {MISO_LED}]

#### On-board Buttons
###set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS33} [get_ports {btn[0]}]
set_property -dict {PACKAGE_PIN J5 IOSTANDARD LVCMOS33} [get_ports {Run}]
...
#### On-board color LEDs
set_property -dict {PACKAGE_PIN V6 IOSTANDARD LVCMOS33} [get_ports {err}];   # RBG0_R
...
set_property -dict {PACKAGE_PIN V3 IOSTANDARD LVCMOS33} [get_ports {sclk}];   # RBG1_G
...
set_property -dict {PACKAGE_PIN T6 IOSTANDARD LVCMOS33} [get_ports {Dout}]
set_property -dict {PACKAGE_PIN T4 IOSTANDARD LVCMOS33} [get_ports {SCLK}]
set_property -dict {PACKAGE_PIN T5 IOSTANDARD LVCMOS33} [get_ports {Data_in}]
set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVCMOS33} [get_ports {Select[3]}]
set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS33} [get_ports {Select[2]}]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports {Select[1]}]
set_property -dict {PACKAGE_PIN R5 IOSTANDARD LVCMOS33} [get_ports {Select[0]}]
