...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets clkin_IBUF]  #Have to set the clock dedicated route false so that the default clock route is ignored and the clock coming externally,
